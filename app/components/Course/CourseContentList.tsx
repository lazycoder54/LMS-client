...
const CourseContentList: FC<Props> = (props) => {
  const [visibleSections, setVisisbleSections] = useState<Set<string>>(
    new Set<string>()
  );
  ...
  const toggleSection = (section: string) => {
    ...
    setVisisbleSections(newVisibleSections);
  };
  ...
  return (
    ...
    >
      {videoSections.map((section: string, sectionIndex: number) => {
        ...
        const sectionVideoCount: number = sectionVideos.length; // number of vides in current section
        ...
        totalCount += sectionVideoCount; //updatethe total count of videos
